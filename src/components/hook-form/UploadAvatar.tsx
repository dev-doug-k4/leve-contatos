...
export default function UploadAvatar({ error, file, fromS3, helperText, sx, ...other }: UploadProps) {
      ...
      >
        ...
        >
          ...
          {file && (
            <>
              {fromS3
                ? <S3Image alt="avatar" imageKey={isString(file) ? file : file.preview} sx={{ zIndex: 8 }} />
